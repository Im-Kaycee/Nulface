"""
Django settings for nulface project.
...
SECRET_KEY = 'django-insecure-v6xro3ajou1q5da%v3)8s!7@+g(q&ms%7gh@z&x6hw5j+0fdm9'
...
WSGI_APPLICATION = 'nulface.wsgi.application'
